...
String webURL = 'https://opensource-demo.orangehrmlive.com/login'
...
WebUI.setText(findTestObject('Page_OrangeHRM/input_Username_txtPassword'), GlobalVariable.userPassword)
